        ...
        if interaction.data.get("custom_id") == "Roles":
            roles_embed = discord.Embed(
                description=(
                    ...
                    "- <@&1307599568824700969>: Driving innovation with ideas and feedback. Use /roles contributor to claim\n"
                    "- <@&1376169325064355940>: Starred the GitHub repo. Use /roles stargazer to claim\n"
